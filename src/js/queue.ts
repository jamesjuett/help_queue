...
function createQueue(data: {[index:string]: any}, page: Page, queueKind: QueueKind, elem: JQuery) {
...
export class Page {
    ...
    constructor(data: {[index:string]: any}, course: Course, queueKind: QueueKind, elem: JQuery) {
